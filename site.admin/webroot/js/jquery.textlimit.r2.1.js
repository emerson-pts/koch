...
//Aplica o limite automaticamente, se o textarea tem o parametro limit
$(document).ready(function(){
	$('input[limit],textarea[limit]').each(function(){
		var counterSelector = $(this).attr("id") + "Counter";
		var counter = $("#" + counterSelector);
		
		//Se o contador não existe, então cria um
		if (counter.length == 0)$(this).after('<span class="counter" id="' + counterSelector + '"></span>');
		
		$(this).textlimit("#" + counterSelector,$(this).attr("limit"));
	});
});
