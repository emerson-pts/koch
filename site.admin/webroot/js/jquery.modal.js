...
(function($)
{
	...
	$.modal = function(options)
	{
		...
		else
		{
			...
			// Modal Class
			var modalClass = settings.modalClass != false ? ' ' + settings.modalClass : '';
			
			// Bloc style
			var contentWrapper = '<div class="modal-content'+modalClass+scrollClass+'"'+contentStyle+'>'+content+'</div>';
		}
		...
		{
			$('<ul class="action-tabs right"><li><a class="modal-close" href="#" title="Close window"><span>Close</span></a></li></ul>')
				.prependTo(win)
