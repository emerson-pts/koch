...
(function (m) {
    function s(e, l) {
        return function (a) {
            return g(e.call(this, a), l)
        }
    }

    function v(e) {
        return function (l) {
            return this.lang().ordinal(e.call(this, l))
        }
    }
    ...
    function b(e) {
        var l = this._data = {}, a = e.years || e.year || e.y || 0,
            b = e.months || e.month || e.M || 0,
            D = e.weeks || e.week || e.w || 0,
            d = e.days || e.day || e.d || 0,
            f = e.hours || e.hour || e.h || 0,
            g = e.minutes || e.minute || e.m || 0,
            h = e.seconds || e.second || e.s || 0;
        e = e.milliseconds || e.millisecond || e.ms || 0;
        this._milliseconds = e + 1E3 * h + 6E4 * g + 36E5 * f;
        this._days =
            d + 7 * D;
        this._months = b + 12 * a;
        l.milliseconds = e % 1E3;
        h += c(e / 1E3);
        l.seconds = h % 60;
        g += c(h / 60);
        l.minutes = g % 60;
    ...
    function g(e, l) {
        for (var a = e + ""; a.length < l;) a = "0" + a;
        return a
    }

    function f(e, l, a) {
        var b = l._milliseconds,
            c = l._days;
        l = l._months;
        var d;
        b && e._d.setTime(+e + b * a);
        c && e.date(e.date() + c * a);
        l && (d = e.date(), e.date(1).month(e.month() + l * a).date(Math.min(d, e.daysInMonth())))
    }

    function k(e, l) {
        var a = Math.min(e.length, l.length),
            b = Math.abs(e.length - l.length),
            c = 0,
            d;
        for (d = 0; d < a; d++)~~ e[d] !== ~~l[d] && c++;
        return c + b
    }

    function p(e) {
        return e ? (!x[e] && E && require("./lang/" + e), x[e]) : h.fn._lang
    }
    ...
    function z(e) {
        var l = e.match(F),
            a, b;
        a = 0;
        for (b = l.length; a < b; a++) u[l[a]] ? l[a] = u[l[a]] : l[a] = l[a].match(/\[.*\]/) ? l[a].replace(/^\[|\]$/g, "") : l[a].replace(/\\/g, "");
        return function (c) {
            var d = "";
            for (a = 0; a < b; a++) d += "function" ==
                typeof l[a].call ? l[a].call(c, e) : l[a];
            return d
        }
    }
    ...
    function P(e, a) {
        function b(a) {
            return e.lang().longDateFormat(a) || a
        }
        for (var c = 5; c-- && G.test(a);) a = a.replace(G, b);
        return A[a] || (A[a] = z(a)), A[a](e)
    }
    ...
    function I(e) {
        var a, b = [];
        if (!e._d) {
            for (a = 0; 7 > a; a++) e._a[a] = b[a] = null == e._a[a] ? 2 === a ? 1 : 0 : e._a[a];
            b[3] += e._tzh || 0;
            b[4] += e._tzm || 0;
            a = new Date(0);
            e._useUTC ? (a.setUTCFullYear(b[0], b[1], b[2]), a.setUTCHours(b[3], b[4], b[5], b[6])) : (a.setFullYear(b[0], b[1], b[2]), a.setHours(b[3], b[4], b[5], b[6]));
            e._d = a
        }
    }
    ...
    function t(e) {
        ...
        for (c = 0; c < a.length; c++)
            if ((d = (Q(a[c]).exec(b) || [])[0]) && (b = b.slice(b.indexOf(d) + d.length)), u[a[c]]) {
                var f = e,
                    g = void 0,
                    h = f._a;
                switch (a[c]) {
                ...
                case "MMM":
                case "MMMM":
                    g = p(f._l).monthsParse(d);
                    null != g ? h[1] = g : f._isValid = !1;
                    break;
                case "D":
                case "DD":
                case "DDD":
                ...
                case "Z":
                case "ZZ":
                    f._useUTC = !0, (g = (d + "").match(Z)) && g[1] && (f._tzh = ~~g[1]), g && g[2] && (f._tzm = ~~g[2]), g && "+" === g[0] && (f._tzh = -f._tzh, f._tzm = -f._tzm)
                }
                null == d && (f._isValid = !1)
            }
        e._isPm && 12 > e._a[3] && (e._a[3] += 12);
        !1 === e._isPm && 12 === e._a[3] && (e._a[3] = 0);
        I(e)
    }

    function q(e, a, b, d, c) {
        return c.relativeTime(a || 1, !! b, e, d)
    }

    function J(e, a, b) {
        a = b - a;
        b -= e.day();
        return b > a && (b -= 7), b < a - 7 && (b += 7), Math.ceil(h(e).add("d", b).dayOfYear() / 7)
    }
    ...
    function y(e) {
        ...
        if (null === a || "" === a) e = null;
            ...
            "string" == typeof a && (e._i = a = p().preparse(a));
            if (h.isMoment(a)) e = d({}, a), e._d = new Date(+a._d);
            else if (b)
                if ("[object Array]" === Object.prototype.toString.call(b)) {
                    for (var a = e, c, f, g = 99; a._f.length;) {
                        c = d({}, a);
                        c._f = a._f.pop();
                        t(c);
                        b = new n(c);
                ...
                else if (f = e, a = f._i, b = aa.exec(a), a === m) f._d = new Date;
            else if (b) f._d = new Date(+b[1]);
                ...
                if (b = f._i, ba.exec(b)) {
                    ...
                    H.exec(b) && (f._f += " Z");
                    t(f)
                } else f._d = new Date(b);
                else "[object Array]" === Object.prototype.toString.call(a) ? (f._a = a.slice(0), I(f)) : f._d = a instanceof Date ? new Date(+a) : new Date(a);
            e = new n(e)
        }
        return e
    }
    ...
    function L(a, b) {
        h.fn[a] = h.fn[a + "s"] = function (a) {
            ...
            return null != a ? (this._d["set" + e + b](a), this) : this._d["get" + e + b]()
        }
    }
    ...
    for (var h, w = Math.round, r, x = {}, E = "undefined" != typeof module && module.exports, aa = /^\/?Date\((\-?\d+)/i, F = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|YYYYY|YYYY|YY|a|A|hh?|HH?|mm?|ss?|SS?S?|X|zz?|ZZ?|.)/g, G = /(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g, Y = /\d\d?/, U = /\d{1,3}/, R = /\d{3}/, S = /\d{1,4}/, T = /[+\-]?\d{1,6}/, V = /[0-9]*[a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF]+\s*?[\u0600-\u06FF]+/i, H = /Z|[\+\-]\d\d:?\d\d/i, X = /T/i, W = /[\+\-]?\d+(\.\d{1,3})?/,
            ba = /^\s*\d{4}-\d\d-\d\d((T| )(\d\d(:\d\d(:\d\d(\.\d\d?\d?)?)?)?)?([\+\-]\d\d:?\d\d)?)?/, K = [
                ["HH:mm:ss.S", /(T| )\d\d:\d\d:\d\d\.\d{1,3}/],
                ["HH:mm:ss", /(T| )\d\d:\d\d:\d\d/],
                ["HH:mm", /(T| )\d\d:\d\d/],
                ["HH", /(T| )\d\d/]
            ], Z = /([\+\-]|\d\d)/gi, B = "Month Date Hours Minutes Seconds Milliseconds".split(" "), C = {
                Milliseconds: 1,
                Seconds: 1E3,
                Minutes: 6E4,
                Hours: 36E5,
                ...
                Months: 2592E6,
                Years: 31536E6
            }, A = {}, N = "DDD w W M D d".split(" "), O = "MDHhmswW".split(""), u = {
                M: function () {
                    return this.month() + 1
                },
                MMM: function (a) {
                ...
                Z: function () {
                    var a = -this.zone(),
                        b = "+";
                    return 0 > a && (a = -a, b = "-"), b + g(~~(a / 60), 2) + ":" + g(~~a % 60, 2)
                },
                ZZ: function () {
                    var a = -this.zone(),
                        b = "+";
                    return 0 > a && (a = -a, b = "-"), b + g(~~(10 * a / 6), 4)
                },
                X: function () {
                    return this.unix()
                }
            }; N.length;) r = N.pop(), u[r + "o"] = v(u[r]);
    for (; O.length;) r = O.pop(), u[r + r] = s(u[r], 2);
    u.DDDD = s(u.DDD, 3);
    a.prototype = {
        set: function (a) {
            var b, c;
        ...
        _months: "Janeiro Fevereiro Março Abril Maio Junho Julho Agosto Setembro Outubro Novembro Dezembro".split(" "),
        months: function (a) {
            return this._months[a.month()]
        },
        _monthsShort: "Jan Fev Mar Abr Mai Jun Jul Ago Set Out Nov Dez".split(" "),
        ...
        monthsParse: function (a) {
            ...
            this._monthsParse || (this._monthsParse = []);
            for (b = 0; 12 > b; b++)
                if (this._monthsParse[b] || (c = h([2E3, b]), d = "^" + this.months(c, "") + "|^" + this.monthsShort(c, ""), this._monthsParse[b] = RegExp(d.replace(".", ""), "i")), this._monthsParse[b].test(a)) return b
        },
    ...
    h.duration = function (a, c) {
        var d = h.isDuration(a),
            f = "number" == typeof a,
            g = d ? a._data : f ? {} : a,
            k;
        return f && (c ? g[c] = a : g.milliseconds = a), k = new b(g), d && a.hasOwnProperty("_lang") && (k._lang = a._lang), k
    };
    h.version = "2.0.0";
    h.defaultFormat = "YYYY-MM-DDTHH:mm:ssZ";
    h.lang = function (b, c) {
        if (!b) return h.fn._lang._abbr;
        c ? (c.abbr = b, x[b] || (x[b] = new a), x[b].set(c)) :
            x[b] || p(b);
        h.duration.fn._lang = h.fn._lang = p(b)
    };
    ...
    h.fn = n.prototype = {
        ...
        isValid: function () {
            return null == this._isValid && (this._a ? this._isValid = !k(this._a, (this._isUTC ? h.utc(this._a) : h(this._a)).toArray()) : this._isValid = !isNaN(this._d.getTime())), !! this._isValid
        },
        utc: function () {
            return this._isUTC = !0, this
        },
        ...
        format: function (a) {
            a = P(this, a || h.defaultFormat);
            return this.lang().postformat(a)
        },
        add: function (a,
            b) {
            var c;
            return "string" == typeof a ? c = h.duration(+b, a) : c = h.duration(a, b), f(this, c, 1), this
        },
        ...
        diff: function (a, b, d) {
            ...
            var f = 6E4 * (this.zone() - a.zone()),
                g, k;
            return b && (b = b.replace(/s$/, "")), "year" === b || "month" === b ? (g = 432E5 * (this.daysInMonth() + a.daysInMonth()), k = 12 * (this.year() - a.year()) + (this.month() - a.month()), k += (this - h(this).startOf("month") - (a - h(a).startOf("month"))) /
                g, "year" === b && (k /= 12)) : (g = this - a - f, k = "second" === b ? g / 1E3 : "minute" === b ? g / 6E4 : "hour" === b ? g / 36E5 : "day" === b ? g / 864E5 : "week" === b ? g / 6048E5 : g), d ? k : c(k)
        },
        from: function (a, b) {
        ...
        dayOfYear: function (a) {
            var b = w((h(this).startOf("day") - h(this).startOf("year")) / 864E5) + 1;
        ...
        lang: function (a) {
            return a === m ? this._lang : (this._lang = p(a), this)
        }
    };
    for (r = 0; r < B.length; r++) L(B[r].toLowerCase().replace(/s$/, ""), B[r]);
    L("year",
        "FullYear");
    h.fn.days = h.fn.day;
    h.fn.weeks = h.fn.week;
    h.fn.isoWeeks = h.fn.isoWeek;
    h.duration.fn = b.prototype = {
        weeks: function () {
        ...
        humanize: function (a) {
            ...
            var d = this.lang(),
                ...
                k = w(h / 24),
                p = w(k / 365),
                f = 45 > f && ["s", f] || 1 === g && ["m"] || 45 > g && ["mm", g] || 1 === h && ["h"] || 22 > h && ["hh", h] || 1 === k && ["d"] || 25 >= k && ["dd", k] || 45 >= k && ["M"] || 345 > k && ["MM", w(k / 30)] || 1 === p && ["y"] || ["yy", p];
            c = (f[2] = c, f[3] = 0 < b, f[4] = d, q.apply({}, f));
            return a && (c = this.lang().pastFuture(b, c)), this.lang().postformat(c)
        },
        lang: h.fn.lang
    };
    for (r in C) C.hasOwnProperty(r) && (M(r, C[r]), ca(r.toLowerCase()));
    M("Weeks", 6048E5);
    h.lang("en", {
        ordinal: function (a) {
            var b = a % 10;
...
(function (m) {
    ...
    var v = m.scrollTo = function (a, n, b) {
        m(window).scrollTo(a, n, b)
    };
    v.defaults = {
        axis: "xy",
        duration: 1.3 <= parseFloat(m.fn.jquery) ? 0 : 1,
        limit: !0
    };
    v.window = function (a) {
        return m(window)._scrollable()
    };
    m.fn._scrollable = function () {
        return this.map(function () {
            if (this.nodeName && -1 == m.inArray(this.nodeName.toLowerCase(), ["iframe", "#document", "html", "body"])) return this;
            var a = (this.contentWindow || this).document || this.ownerDocument || this;
            return /webkit/i.test(navigator.userAgent) ||
                "BackCompat" == a.compatMode ? a.body : a.documentElement
        })
    };
    m.fn.scrollTo = function (a, n, b) {
        "object" == typeof n && (b = n, n = 0);
        "function" == typeof b && (b = {
            onAfter: b
        });
        "max" == a && (a = 9E9);
        b = m.extend({}, v.defaults, b);
        n = n || b.duration;
        b.queue = b.queue && 1 < b.axis.length;
        b.queue && (n /= 2);
        b.offset = s(b.offset);
        b.over = s(b.over);
        return this._scrollable().each(function () {
            function d(c) {
                g.animate(p, n, b.easing, c && function () {
                    c.call(this, a, b)
                })
            }
            if (null != a) {
                ...
                case "string":
                    ...
                    if (!f.length) return;
                case "object":
                    if (f.is || f.style) k = (f = m(f)).offset()
                }
                m.each(b.axis.split(""), function (a, m) {
                    var n = "x" == m ? "Left" : "Top",
                        t = n.toLowerCase(),
                        q = "scroll" + n,
                        s = c[q],
                        y = v.max(c, m);
                    k ? (p[q] = k[t] + (z ? 0 : s - g.offset()[t]), b.margin && (p[q] -= parseInt(f.css("margin" + n)) || 0, p[q] -= parseInt(f.css("border" + n + "Width")) || 0), p[q] += b.offset[t] || 0, b.over[t] && (p[q] += f["x" == m ? "width" : "height"]() * b.over[t])) : (n = f[t], p[q] = n.slice && "%" == n.slice(-1) ? parseFloat(n) / 100 * y : n);
                    b.limit && /^\d+$/.test(p[q]) &&
                        (p[q] = 0 >= p[q] ? 0 : Math.min(p[q], y));
                    !a && b.queue && (s != p[q] && d(b.onAfterFirst), delete p[q])
                });
                d(b.onAfter)
            }
        }).end()
    ...
    v.max = function (a, n) {
        var b = "x" == n ? "Width" : "Height",
            d = "scroll" + b;
        if (!m(a).is("html,body")) return a[d] - m(a)[b.toLowerCase()]();
        var b = "client" + b,
            c = a.ownerDocument.documentElement,
            g = a.ownerDocument.body;
        return Math.max(c[d], g[d]) - Math.min(c[b], g[b])
    }
})(jQuery);

function Timeline(m, s, v) {
    var a = this,
        n = $(document.body);
    ...
    this._years = [];
    this._readmore_text = "saiba mais";
    ...
    this._createElement = function (b, d) {
        ...
        //a._options.destaque || c.addClass("destaque");
        null !== b.destaque ? c.addClass("destaque") : c.removeClass("destaque");
        null !== b.title ? $("<div>").addClass("title").html('<span class="label">' +
            b.title + '</span><span class="date">' + a._getDateString(b.date, b.dateFormat) + "</span>").appendTo(c) : c.addClass("notitle");
        switch (b.type) {
        case "iframe":
            var g = $("<div>").addClass("content loading").height(b.height).appendTo(c);
            ...
            break;
        case "blog_post":
            null !== b.image && (g = $("<div>").addClass("img_container").append($("<img>").attr("src", b.image)).appendTo(c), a._options.lightbox && g.append($("<div>").addClass("img_overlay").html('<span class="magnifier" data-type="blog_post" data-img="' +
                b.image + '"></span>')));
            null !== b.content && $("<div>").addClass("content").html(b.content).appendTo(c);
            null !== b.readmore && $("<div>").addClass("readmore").html('<a href="' + b.readmore + '">' + a._readmore_text + "</a>").appendTo(c);
            break;
        case "gallery":
            if (b.images.length) {
                var g = $("<div>").addClass("scroll_container").appendTo(c),
                    f = "";
                $(b.images).each(function (c, d) {
                    f += '<div class="img_container"><img height="' + b.height + '" src="' + d + '" />';
                    a._options.lightbox && (f += '<div class="img_overlay"><span class="magnifier" data-total="' +
                        b.images.length + '" data-order="' + c + '" data-type="gallery" data-img="' + d + '"></span></div>');
                    f += "</div>"
                });
                g.html(f)
            }
        ...
        case "slider":
            var k = "";
            $(b.images).each(function (c, d) {
                k += '<div data-total="' + b.images.length + '" data-order="' + c + '" class="img_container' + (0 === c ? " active" : "") + '" style="display:' + (0 === c ? "block" : "none") + ';"><img src="' + d + '" />';
                a._options.lightbox && (k += '<div class="img_overlay"><span class="magnifier" data-total="' + b.images.length + '" data-order="' + c + '" data-type="slider" data-img="' +
                    d + '"></span></div>');
                k += "</div>"
            });
            1 < b.images.length && (k += '<span class="slider_prev"></span><span class="slider_next"></span>');
            $("<div>").addClass("content").width(b.width).height(b.height).html(k).appendTo(c);
    ...
    this._createSeparator = function (b) {
        b = $("<div>").addClass("date_separator").attr("id", "timeline_date_separator_" + b).html("<span>" + b + "</span>").appendTo(a._container);
        a._options.animation || b.addClass("animated");
        a._separators.push(b)
    };
    this._setContinerWidth = function () {
        a._max_element_width && ("dual" === a._options.columnMode ? a._container.width(2 * a._max_element_width + a._spine_margin) :
    ...
    this._render = function (b, d) {
        ...
        $(b).each(function (b, n) {
            ...
            var m = parseInt(n.date.split("-")[0], 10);
            if (-1 === $.inArray(m, a._years)) {
                a._years.push(m);
                a._options.showYear && 1 < a._years.length && a._createSeparator(m);
                if (a._options.showYear || 0 === b) "dual" === a._options.columnMode ? (c = $("<div>").addClass("column column_left year_" + m).appendTo(a._container), g = $("<div>").addClass("column column_right year_" +
                    m).appendTo(a._container)) : "left" === a._options.columnMode ? c = $("<div>").addClass("column column_left year_" + m).appendTo(a._container) : "right" === a._options.columnMode ? g = $("<div>").addClass("column column_right year_" + m).appendTo(a._container) : "center" === a._options.columnMode && (f = $("<div>").addClass("column column_center year_" + m).appendTo(a._container));
                k = !0
            } else !0 === d && ("dual" === a._options.columnMode ? (null === c && (c = $(".column_left.year_" + m), k = 0 === $(".year_" + m).children().length % 2 ? !0 : !1), null === g && (g =
                $(".column_right.year_" + m), k = 0 === $(".year_" + m).children().length % 2 ? !0 : !1)) : "left" === a._options.columnMode ? c = null !== c ? c : $(".column_left.year_" + m) : "right" === a._options.columnMode ? g = null !== g ? g : $(".column_right.year_" + m) : "center" === a._options.columnMode && (f = null !== f ? f : $(".column_center.year_" + m)));
            "dual" === a._options.columnMode ? a._createElement(n, k ? c : g) : "left" === a._options.columnMode ? a._createElement(n, c) : "right" === a._options.columnMode ? a._createElement(n, g) : "center" === a._options.columnMode && a._createElement(n,
                f);
            k = k ? !1 : !0
        });
        a._setContinerWidth()
    ...
    this._updateSlider = function (b, d) {
        ...
        if (!a._overlay.hasClass("open")) {
            var c = b.find(".img_container.active").removeClass("active"),
                g = "next" === d ? c.data("order") === c.data("total") - 1 ? b.find(".img_container:first").addClass("active") : c.next().addClass("active") : 0 === c.data("order") ? b.find(".img_container:last").addClass("active") : c.prev().addClass("active");
            c.fadeOut();
            g.fadeIn()
        }
    ...
    this._startAnimation = function (b, d) {
        ...
        var c = 0;
        $(a._elements).each(function (d, f) {
            f.hasClass("animated") || (c++, setTimeout(function (c) {
                a._use_css3 ?
                    f.addClass("animated") : f.hide().addClass("animated").fadeIn();
                d === a._elements.length - 1 && setTimeout(b, 200)
            }, (a._options.showYear ? 1E3 : 500) + 100 * c))
        });
        return !0
    };
    this._getDateString = function (a, d) {
        var c = a.split("-");
        if (3 <= c.length) var g = c[0],
        f = c[1], k = c[2];
        else 2 === c.length ? (g = c[0], f = c[1], k = "01") : 1 === c.length && (g = c[0], k = f = "01");
        return moment(g + "-" + f + "-" + k).format(d)
    };
    this._sortData = function (b) {
        b.sort(function (b, c) {
            return "desc" === a._options.order ? parseInt(c.date.replace(/-/g, ""), 10) - parseInt(b.date.replace(/-/g,
                ""), 10) : parseInt(b.date.replace(/-/g, ""), 10) - parseInt(c.date.replace(/-/g, ""), 10)
        });
        return b
    };
    this._openLightBox = function (b, d) {
        ...
        setTimeout(function () {
            ...
            c.onload = function () {
                ...
                var g = a._getLightboxSize(c.width, c.height),
                    g = {
                        width: g.width,
                        height: g.height,
                        margin: "-" + g.height / 2 + "px 0px 0px -" + g.width / 2 + "px"
                    };
                a._use_css3 ? a._lightbox.addClass("loaded").css(g) : a._lightbox.css(g).animate({
                    top: "50%",
                    opacity: 1
                }, 300, function () {
    ...
    this._getLightboxSize = function (a, d) {
        var c = 0.9 * $(window).width(),
            ...
            f = a,
            k = d;
        if (a > c || d > g) a > c && d <= g ? (f = c, k = d / (a / f)) : d > g && a <= c ? (k = g, f = a / (d / k)) : (f = c, k = d / (a / f), k > g && (k = g, f = a / (d / k)));
        return {
            width: f,
            height: k
        }
    ...
    this._navLightBox = function (b, d) {
        ...
        f.onload = function () {
            ...
            a._lightbox.children("img").attr("src", g);
            var b = a._getLightboxSize(f.width, f.height),
                b = {
                    width: b.width,
                    height: b.height,
    ...
    this.display = function () {
        ...
        a._options.lightbox && (a._overlay = $(".timeline_overlay"), a._overlay.length ? a._lightbox = a._overlay.children(".lightbox") : (a._overlay = $("<div>").addClass("timeline_overlay"), a._lightbox = $("<div>").addClass("lightbox").html('<span class="prev"></span><span class="next"></span>').appendTo(a._overlay), a._overlay.appendTo(n)));
        ...
        a._spine =
            $("<div>").addClass("spine").appendTo(a._container);
        a._options.animation || a._spine.addClass("animated");
        a._render(a._data);
        a._container.data("loaded", !0).appendTo(m);
