...
<div id="vitrine" class="carousel slide">
		...
		<?php foreach($vitrines as $key => $vitrine): ?>
			<div 
				...
				style="background: #ffe7d2 url(<?php 
					...
					$crop_pos = 'center '.$vitrine['Vitrine']['imagem_align'];
					
					$thumb = $this->Image->thumb(array('src' => $vitrine['Vitrine']['imagem'], 'size' => '1600*940', 'crop_pos' => $crop_pos, 'crop' => $crop, 'output' => 'jpg', 'jpg_quality' => 70));
	...
	<?php endif; ?>
	<a class="carousel-scroll" href="#carousel-end">&darr;</a>
</div>
<?php
